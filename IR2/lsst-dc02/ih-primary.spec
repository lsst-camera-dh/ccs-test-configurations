...
MJD-END     MJD     ${endIntegrationTime}   MJD derived from DATE-END
# This overrides the daqv4-setting, and makes DATE-OBS equals to DATE-BEG
DATE-OBS    Date    ${startIntegrationTime} Time at the start of integration
MJD-OBS     MJD     ${startIntegrationTime} Modified Julian Date derived from DATE-BEG
#
#
