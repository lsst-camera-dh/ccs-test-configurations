...
FILTER2     String  ${CCOBLED|_NULL_}  	 CCOB LED
STAGEX     Float ${ts8-motorplatform/AxisStatus/X/position} X stage position
STAGEY     Float ${ts8-motorplatform/AxisStatus/Y/position} Y stage position
STAGEZ     Float ${ts8-motorplatform/AxisStatus/Z/position} Z stage position
