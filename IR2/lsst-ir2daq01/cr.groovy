...
builder.main (RaftsMain, nodeTags:taskConfig) {
    ...
    "${wreb}.ClkHI"  (Channel, description: "CLK_H PS current", format: ".1f", units: "mA",
                      devcName: "$wreb", hwChan: PowerAdcs.ADC_CLKH_CURRENT, type: "POWER", scale: 3000, pageId: 1)

    "${wreb}.ClkLV"  (Channel, description: "CLK_L PS voltage", units: "Volts",
                      devcName: "$wreb", hwChan: SlowAdcs.CHAN_V_CLKL, type: "CRVOLT", pageId: 1)
    ...
    "${wreb}.ODI"    (Channel, description: "OD PS current", format: ".1f", units: "mA",
                      devcName: "$wreb", hwChan: PowerAdcs.ADC_OD_CURRENT, type: "POWER", scale: 3000, pageId: 1)
    ...
    "${wreb}.HtrI"   (Channel, description: "Heater PS current", format: ".1f", units: "mA",
                      devcName: "$wreb", hwChan: PowerAdcs.ADC_HTR_CURRENT, type: "POWER", scale: 3000, pageId: 1)
    ...
    "${wreb}.PClkU"  (Channel, description: "Clock rails\\Parallel upper", units: "Volts",
                      devcName: "$wreb", hwChan: SlowAdcs.CHAN_V_DPHI, type: "CRVOLT", pageId: 1)

    "${wreb}.PClkL"  (Channel, description: "Parallel lower", format: ".2f", units: "Volts",
    ...
    "${greb}.ClkHI"   (Channel, description: "CLK_H PS current", format: ".1f", units: "mA",
                       devcName: "$greb", hwChan: PowerAdcs.ADC_CLKH_CURRENT, type: "POWER", scale: 3000, pageId: 2)
    ...
    "${greb}.ODI"     (Channel, description: "OD PS current", format: ".1f", units: "mA",
                       devcName: "$greb", hwChan: PowerAdcs.ADC_OD_CURRENT, type: "POWER", scale: 3000, pageId: 2)
    ...
    "${greb}.HtrI"    (Channel, description: "Heater PS current", format: ".1f", units: "mA",
                       devcName: "$greb", hwChan: PowerAdcs.ADC_HTR_CURRENT, type: "POWER", scale: 3000, pageId: 2)
    ...
    "${greb}.PClkU"   (Channel, description: "Clock rails\\Parallel upper", units: "Volts",
                       devcName: "$greb", hwChan: SlowAdcs.CHAN_V_DPHI, type: "CRVOLT", pageId: 2)

    "${greb}.PClkL "  (Channel, description: "Parallel lower", format: ".2f", units: "Volts",
