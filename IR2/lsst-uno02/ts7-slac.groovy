...
CCSBuilder builder = ["ts7-1"]

builder.
    main (TSSubSys, configName:"bnlts8", broadcastMillis:10000) {

//    Bias  (KeithleySimDevice, host:"PH", port:57600)

//    PhotoDiode  (KeithleyDevice, host:"PJ", port:57600)

//    PhotoDiode  (KeithleySimDevice, host:"PJ", port:57600)
//    Cryo   (CryoCon24cDevice, itype:1, host:"A103LM1S", port:19200)
    Cryo   (CryoCon24cDevice, itype:0, host:"192.168.2.5", port:5000)
  
//    VacuumGauge (MicroIonDevice, itype:1, host:"DB93", port:19200, addr:1)
    
    VQMonitor (GPVacMon835Device, serialdev:"/dev/ttyGP835", baud:9600)
    
//    Enviro (NetBotzDevice, ef:"/home/homer/bnlenviro.dat")

//    Lamp (NewportLampDevice, itype:1, host:"PF", baud:9600)
    
//    Shutter (OrielShutterDevice, host:"?", port:9600, addr:0)
    
//    PDU (TrippLitePDUDevice, host:"130.199.47.44", port:23)
