...
org.lsst.ccs.application.args=--description RebPowerSupply --alias ts7-rebpower --initialConfiguration build:<alias>,Limits:<alias>,Power:<alias>,Services:<alias>,General:<alias>,timers:<alias>
