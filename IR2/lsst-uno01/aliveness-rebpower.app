...
org.lsst.ccs.application.args=--description RebPowerSupply --alias aliveness-rebpower --initialConfiguration build:<alias>,Limits:<alias>,Power:<alias>,General:<alias>,timers:<alias>,Devices:<alias>
